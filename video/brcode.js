...
var Progress = (function () {
    ...
    Progress.prototype.move = function (percent, preventEvent) {
        if (preventEvent === void 0) { preventEvent = true; }
        percent = Math.max(+percent, 0);
        percent = Math.min(percent, 1);
...
var src_VidoePage = (function () {
    ...
    VidoePage.prototype.mouseEnd = function () {
        ...
        setTimeout(function () {
            ...
            if (_this.touchRange > 100) {
                ...
                _this.templete.first.innerHTML = '';
                ...
                _this.templete.three.innerHTML = '';
    ...
    VidoePage.prototype.initPlayer = function (data, ele) {
        var _this = this;
        ele.innerHTML = this.tplVideo(data.url);
        ...
        video.addEventListener('loadedmetadata', function () {
            ...
            video.progress = new progress(ele.querySelector("." + _this.prefix + "-time"), {
                value: 0,
                ppx: _this.prefix
            });
    ...
    VidoePage.prototype.tplVideo = function (url) {
        return "<div class=\"" + this.prefix + "-wrap\">\n                <video class=\"" + this.prefix + "-video\" src=\"" + url + "\" webkit-playsinline=\"true\" playsinline x5-video-player-type=\"h5\"  x-webkit-airplay=\"true\"></video>\n            </div>\n            <div class=\"" + this.prefix + "-event\"></div>\n            <div class=\"" + this.prefix + "-time\"></div>";
    };
    VidoePage.prototype.tpl = function () {
        return "<div class=\"" + this.prefix + "\">\n            <div class=\"" + this.prefix + "-first " + this.prefix + "-top\"></div>\n            <div class=\"" + this.prefix + "-sec\"></div>\n            <div class=\"" + this.prefix + "-three " + this.prefix + "-bottom\"></div>\n        </div>";
    };
